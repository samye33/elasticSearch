...
@Document(indexName = "order_info_es", type = "order_info",refreshInterval = "-1")
public class OrderInfoVo implements Serializable {
    ...
    private OrderClueCustomStudentRelationVo orderClueCustomStudentRelationVo;
    ...
    public OrderClueCustomStudentRelationVo getOrderClueCustomStudentRelationVo() {
        return orderClueCustomStudentRelationVo;
    }

    public void setOrderClueCustomStudentRelationVo(OrderClueCustomStudentRelationVo orderClueCustomStudentRelationVo) {
        this.orderClueCustomStudentRelationVo = orderClueCustomStudentRelationVo;
    }
}